...
import { getPartners, getProducts, getProjects, getServices, getSiteSettings, getTenderDocuments } from "@/lib/cms";

export default async function Home() {
  const [{ company, stats }, services, products, tenderDocuments, projects, partners] = await Promise.all([
    getSiteSettings(),
    getServices(),
    getProducts(),
    getTenderDocuments(),
